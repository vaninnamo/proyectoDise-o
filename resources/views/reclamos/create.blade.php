          ...
          <form class="needs-validation" novalidate="">
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <input type="date" class="form-control" id="fecha" name="fecha"  value="<?php echo date("d-m-Y");?>">
                </div>
                <div class="col-md-3 mb-3">
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57'  id="dni" max="8" placeholder="DNI" value="" required="">
                 </div>
                <div class="col-md-6 mb-4">
                    <label for="nomap">Nombre y Apellido</label>
                    <input type="text" class="form-control" id="nomap" placeholder="Nombre y Apellido del cliente" value="">
                </div> 
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control" id="ciudad" placeholder="Ciudad" value="" required="">
              </div>
                <div class="col-md-3 mb-3">
                        <label for="provincia">Provincia</label>
                        <input type="text" class="form-control" id="provincia" placeholder="Provincia" value="" required="">
                </div>
                <div class="col-md-3 mb-3">
