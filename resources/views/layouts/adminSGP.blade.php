            ...
            <ul class="nav navbar-top-links navbar-right">
                 <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        Administrador <i class="fa fa-user fa-fw"></i>  <i class="fa fa-caret-down"></i>
                    </a>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="">
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{!!URL::to('/usucreate')!!}"><i class='fa fa-plus fa-fw'></i> Agregar</a>
                                </li>
                                <li>
                                    <a href="{!!URL::to('/listausu')!!}"><i class='fa fa-list-ol fa-fw'></i> Lista de Usuarios</a>
                                </li>
                            </ul>
                        </li>
                        <li class="">
